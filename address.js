...
window.PGWS.changeAddress = function(cd) {
    ...
    if(document.getElementById(cd + '44').checked) {
       tt = document.getElementById(cd + '55').options[document
               .getElementById(cd + '55').selectedIndex].text;
    } else {
        tt = document.getElementById(cd + '77').value;
    }
  document.getElementById(cd + '222').value = document.getElementById(cd
          + '11').value
          + ','
          + document.getElementById(cd + '22').options[document
                  .getElementById(cd + '22').selectedIndex].text
          + ','
          + document.getElementById(cd + '33').options[document
                  .getElementById(cd + '33').selectedIndex].text
          + ','
          + tt 
          + ','
